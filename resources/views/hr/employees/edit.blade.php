            ...
            <div class="erp-card-body">
                ...
                @if($employee->user && $employee->user->role === 'admin')
                    <div class="erp-alert erp-alert-warning mb-4">
                        ...
                        <strong>ข้อมูลผู้ดูแลระบบ (Admin) - HR ดูได้อย่างเดียว</strong><br>
                        <small>HR ไม่มีสิทธิ์แก้ไขข้อมูล Admin กรุณาติดต่อ Admin เท่านั้น</small>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            <label class="erp-label">รหัสพนักงาน</label>
                            <input type="text" class="erp-input" style="color: #818cf8; font-weight: 600; background: var(--input-bg); opacity: 0.6;"
                                value="{{ $employee->employee_code }}" readonly>
                        </div>
                        <div class="col-md-4">
                            <label class="erp-label">แผนก</label>
                            <input type="text" class="erp-input" style="opacity: 0.6;" value="{{ $employee->department->name ?? '-' }}" readonly>
                        </div>
                        <div class="col-md-4">
                            <label class="erp-label">ตำแหน่ง</label>
                            <input type="text" class="erp-input" style="opacity: 0.6;" value="{{ $employee->position->name ?? '-' }}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-2">
                            ...
                            <input type="text" class="erp-input" style="opacity: 0.6;" value="{{ $employee->prefix ?? '-' }}" readonly>
                        </div>
                        <div class="col-md-5">
                            <label class="erp-label">ชื่อ</label>
                            <input type="text" class="erp-input" style="opacity: 0.6;" value="{{ $employee->firstname }}" readonly>
                        </div>
                        <div class="col-md-5">
                            <label class="erp-label">นามสกุล</label>
                            <input type="text" class="erp-input" style="opacity: 0.6;" value="{{ $employee->lastname }}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-4">
                            ...
                            <input type="text" class="erp-input" style="opacity: 0.6;" value="{{ $employee->start_date ?? '-' }}" readonly>
                        </div>
                        <div class="col-md-4">
                            <label class="erp-label">เพศ</label>
                            <input type="text" class="erp-input" style="opacity: 0.6;"
                                value="{{ $employee->gender == 'male' ? 'ชาย' : ($employee->gender == 'female' ? 'หญิง' : 'อื่นๆ') }}" readonly>
                        </div>
                        <div class="col-md-4">
                            <label class="erp-label">สถานะ</label>
                            <input type="text" class="erp-input" style="opacity: 0.6;"
                                value="{{ $employee->status == 'active' ? 'ทำงานอยู่' : ($employee->status == 'inactive' ? 'พักงาน' : 'ลาออก') }}" readonly>
                        </div>
                    </div>
                    ...
                    <h5 class="mb-3 mt-4" style="font-size: 14px; font-weight: 600; color: #fbbf24; border-bottom: 1px solid rgba(251,191,36,0.2); padding-bottom: 8px;">
                        <i class="fas fa-lock me-2"></i>ข้อมูลเข้าระบบ
                    </h5>
                    <div class="row mb-4">
                        <div class="col-md-4">
                            <label class="erp-label">ชื่อผู้ใช้งาน (Username)</label>
                            <input type="text" class="erp-input" style="opacity: 0.6;" value="{{ $employee->user->username }}" readonly>
                        </div>
                        <div class="col-md-4">
                            <label class="erp-label">สิทธิ์การใช้งาน</label>
                            <input type="text" class="erp-input" style="opacity: 0.6; color: #f87171; font-weight: 600;" value="ผู้ดูแลระบบ (Admin)" readonly>
                        </div>
                    </div>

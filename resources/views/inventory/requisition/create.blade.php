...
.item-card .item-badge.type-disposable {
    background: rgba(56, 189, 248, 0.15);
    color: #38bdf8;
}

.item-card .item-badge.type-consumable {
...
<div class="d-flex justify-content-between align-items-start mb-4">
    <div>
        <h4 class="mb-1" style="font-size: 18px; font-weight: 600; color: var(--text-primary);">
            <i class="fas fa-plus me-2" style="color: #f59e0b;"></i>สร้างใบเบิกอุปทาน
        </h4>
    ...
    <div class="row g-3">
            ...
            <div class="erp-card mb-3">
                <div class="erp-card-header">
                    <span class="erp-card-title">
                        <i class="fas fa-info-circle me-2" style="color: #f59e0b;"></i>ข้อมูลใบเบิก
                    </span>
                </div>
        ...
        <div class="col-lg-7 col-md-6">
            <div class="erp-card">
                <div class="erp-card-header">
                    <span class="erp-card-title">
                        <i class="fas fa-box me-2" style="color: #f59e0b;"></i>เลือกรายการสินค้าเบิก
                    </span>
                </div>
                <div class="erp-card-body">
                    {{-- Search & Filter --}}
                    ...
                    <div id="selectedItemsContainer" style="margin-top: 20px; display: none;">
                        <h6 style="font-weight: 600; color: var(--text-primary); margin-bottom: 12px;">
                            <i class="fas fa-check-circle me-2" style="color: #f59e0b;"></i>รายการที่เลือก
                        </h6>
                    ...
                    <div class="erp-alert erp-alert-warning mt-3">

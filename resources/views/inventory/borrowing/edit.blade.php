...
@section('title', 'แก้ไขใบยืม - JST ERP')

@section('content')
<div class="d-flex justify-content-between align-items-start mb-4">
    <div>
        <h4 class="mb-1" style="font-size: 18px; font-weight: 600; color: var(--text-primary);">
            <i class="fas fa-edit me-2" style="color: #818cf8;"></i>แก้ไขใบยืม
        </h4>
        <p style="font-size: 13px; color: var(--text-muted); margin: 0;">แก้ไขรายละเอียดใบยืม</p>
    </div>
